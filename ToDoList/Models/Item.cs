...
namespace ToDoList.Models
{
  public class Item
  {
      ...
      private int _id;
      // We no longer declare private int _categoryId;
      ...
      public static Item Find(int id)
        {
          ...
          Item newItem = new Item(itemName, itemId);//constructor
          conn.Close();
          if (conn != null)
          {
            conn.Dispose();
     ...
     //  public void Delete()//idk if this needs to chnage
     // {
     //   MySqlConnection conn = DB.Connection();
     //   conn.Open();
     //   var cmd = conn.CreateCommand() as MySqlCommand;
     //   cmd.CommandText = @"DELETE FROM items WHERE id = @ItemId; DELETE FROM categories WHERE id = @ItemId;";
    ...
    public void AddCategory(Category newCategory)
    {
      ...
      conn.Open();
      var cmd = conn.CreateCommand() as MySqlCommand;
      //this adds an entry to the categories_items join table containg IDs for relevant Item and Category objects
